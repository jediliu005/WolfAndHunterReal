...
public class WifiOnlineActivity extends Activity {
            ...
            */
            if (intent.getAction().equals(WifiManager.NETWORK_STATE_CHANGED_ACTION)) {//wifi连接上与否
                ...
                if (wifistate == WifiManager.WIFI_STATE_DISABLED) {
                    ...
                    WifiInfo wifiInfo = wifiManager.getConnectionInfo();
                    Toast.makeText(WifiOnlineActivity.this, "系统开启wifi:" + wifiInfo.getSSID(), Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    public void createHotSpot(View view) {
        ...
        WifiConfiguration wifiConfiguration = WifiHotspotController.createWifiConfiguration(wifiManager, "wifiTest", "010320", 3, "ap");
    ...
    public void connectHotSpot(View view) {
        initWifiParams();
        WifiConfiguration wifiConfiguration = WifiHotspotController.createWifiConfiguration(wifiManager, "wifiTest", "010320", 3, "wifi");
        WifiHotspotController.connectHotspot(wifiManager, wifiConfiguration);
